...
test("FEATURE_NAMES has 18 stable columns in fixed order", () => {
  assert.equal(FEATURE_NAMES.length, 18);
  // First five are prompt-shape; last four are categorical lookups.
...
test("defaultManifest exposes the canonical schema", () => {
  ...
  assert.equal(m.feature_names.length, 18);
...
test("encodeFeatures produces a Float64Array in canonical order", () => {
